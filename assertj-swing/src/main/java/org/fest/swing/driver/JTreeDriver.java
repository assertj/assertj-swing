...
public class JTreeDriver extends JComponentDriver {
  ...
  @RunsInEDT
  private @Nonnull
  Point scrollToRow(@Nonnull JTree tree, int row) {
  ...
  private @Nonnull
  Point scrollToPath(@Nonnull JTree tree, @Nonnull String path) {
  ...
  Triple<Boolean, Point, Integer> scrollToRowAndGetToggleInfo(final @Nonnull JTree tree, final int row,
  ...
  @RunsInEDT
  private static @Nonnull
  Triple<Boolean, Point, Integer> scrollToMatchingPathAndGetToggleInfo(final @Nonnull JTree tree,
      final @Nonnull String path, final @Nonnull JTreePathFinder pathFinder, final @Nonnull JTreeLocation location) {
    Triple<Boolean, Point, Integer> result = execute(new GuiQuery<Triple<Boolean, Point, Integer>>() {
      @Override
      protected Triple<Boolean, Point, Integer> executeInEDT() {
        checkEnabledAndShowing(tree);
  ...
  @RunsInEDT
  public @Nonnull
  JPopupMenu showPopupMenu(@Nonnull JTree tree, int row) {
  ...
  @RunsInEDT
  public @Nonnull
  JPopupMenu showPopupMenu(@Nonnull JTree tree, @Nonnull String path) {
  ...
  @RunsInEDT
  private @Nonnull
  Point scrollAndSelectRow(@Nonnull JTree tree, int row) {
    Pair<Boolean, Point> info = scrollToRow(tree, row, location());
    Point p = checkNotNull(info.second);
    if (!info.first) {
  ...
  @RunsInEDT
  private static @Nonnull
  Pair<Boolean, Point> scrollToRow(final @Nonnull JTree tree, final int row, final @Nonnull JTreeLocation location) {
  ...
  @RunsInCurrentThread
  private static @Nonnull
  Point scrollToVisible(@Nonnull JTree tree, int row, @Nonnull JTreeLocation location) {
  ...
  @RunsInEDT
  private @Nonnull
  Point selectMatchingPath(@Nonnull JTree tree, @Nonnull String path) {
    Triple<TreePath, Boolean, Point> info = scrollToMatchingPath(tree, path);
    robot.waitForIdle();
    Point where = checkNotNull(info.third);
    if (!info.second) {
  ...
  @RunsInEDT
  private @Nonnull
  Triple<TreePath, Boolean, Point> scrollToMatchingPath(@Nonnull JTree tree, @Nonnull String path) {
  ...
  @RunsInEDT
  private static @Nonnull
  Pair<Boolean, Point> scrollToPathToSelect(final @Nonnull JTree tree, final @Nonnull TreePath path,
      final @Nonnull JTreeLocation location) {
    Pair<Boolean, Point> result = execute(new GuiQuery<Pair<Boolean, Point>>() {
      @Override
      protected Pair<Boolean, Point> executeInEDT() {
  ...
  @RunsInCurrentThread
  private static @Nonnull
  Point scrollToTreePath(@Nonnull JTree tree, @Nonnull TreePath path, @Nonnull JTreeLocation location) {
  ...
  @RunsInEDT
  private @Nonnull
  Description selectionProperty(@Nonnull JTree tree) {
  ...
  @RunsInEDT
  private static @Nonnull
  Description editableProperty(@Nonnull JTree tree) {
  ...
  @RunsInEDT
  public @Nullable
  String nodeValue(@Nonnull JTree tree, @Nonnull String path) {
