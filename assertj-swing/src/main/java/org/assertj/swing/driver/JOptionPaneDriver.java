...
public class JOptionPaneDriver extends JComponentDriver {
  ...
  @RunsInEDT
  public @Nullable
  String title(@Nonnull JOptionPane optionPane) {
  ...
  @RunsInEDT
  public @Nonnull
  JButton okButton(@Nonnull JOptionPane optionPane) {
  ...
  @RunsInEDT
  public @Nonnull
  JButton cancelButton(@Nonnull JOptionPane optionPane) {
  ...
  @RunsInEDT
  public @Nonnull
  JButton yesButton(@Nonnull JOptionPane optionPane) {
  ...
  @RunsInEDT
  public @Nonnull
  JButton noButton(@Nonnull JOptionPane optionPane) {
    return buttonWithTextFromUIManager(optionPane, "OptionPane.noButtonText");
  }

  @RunsInEDT
  private @Nonnull
  JButton buttonWithTextFromUIManager(@Nonnull JOptionPane optionPane, @Nonnull String key) {
  ...
  @RunsInEDT
  public @Nonnull
  JButton buttonWithText(@Nonnull JOptionPane optionPane, @Nullable String text) {
  ...
  @RunsInEDT
  public @Nonnull
  JButton buttonWithText(@Nonnull JOptionPane optionPane, @Nonnull Pattern pattern) {
