...
public class JTreeDriver_unselectRow_withInvalidIndex_Test extends JTreeDriver_TestCase {
  ...
  public JTreeDriver_unselectRow_withInvalidIndex_Test(int invalidRow) {
  ...
  public void should_Throw_Error_If_Given_Row_Index_Is_Out_Of_Bounds() {
    showWindow();
    driver.unselectRow(tree, invalidRow);
  }
}
