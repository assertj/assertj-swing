...
public class BasicRobot_findActivePopupMenu_Test extends BasicRobot_TestCase {
   ...
   public static JPopupMenu[] createAndSetPopupMenuWithCascade(
           final int cascadePosition, final JComponent c, final String itemOne,
   ...
   public static JPopupMenu[] createAndSetPopupMenuWithCascadeWithCascade(
           final int cascadeCascadePosition, final JComponent c, final String itemOne,
           final String itemTwo) {
      return execute(() -> {
    ...
    * <p>
    * The N is calculated from the calling methods method-name, via use of
    * extraction from the stack-trace. No check is done on the range of the N
    * value for tests.
    */
