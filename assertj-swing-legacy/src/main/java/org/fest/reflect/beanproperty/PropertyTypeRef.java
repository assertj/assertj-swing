 ...
 * lost due to <a href="http://docs.oracle.com/javase/tutorial/java/generics/erasure.html" target="_blank">type
 * erasure</a>.
 * 
...
public class PropertyTypeRef<T> {
  ...
  /**
   * Specifies the <a href="http://docs.oracle.com/javase/tutorial/javabeans/index.html" target="_blank">JavaBean</a> to
   * access the property from.
   * <p/>
   * Examples:
   * 
   * <pre>
   ...
   */
  public @Nonnull
  PropertyAccessor<T> in(@Nonnull Object target) {
