...
/**
 * Stores the name of the <a href="http://docs.oracle.com/javase/tutorial/javabeans/index.html"
 * target="_blank">JavaBeans</a> property to access.
 * <p/>
...
public final class PropertyName {
  ...
  /**
   * Specifies the data type of the <a href="http://docs.oracle.com/javase/tutorial/javabeans/index.html"
   * target="_blank">JavaBeans</a> property to access.
   * <p/>
   * Examples:
   * 
   ...
   */
  public @Nonnull
  <T> PropertyType<T> ofType(@Nonnull Class<T> type) {
    return new PropertyType<T>(name, type);
  }

  /**
   * Specifies the data type of the <a href="http://docs.oracle.com/javase/tutorial/javabeans/index.html"
   * target="_blank">JavaBeans</a> property to access. This method uses {@link TypeRef} instead of {@link Class} to
   * preserve generic types that otherwise would be lost due to <a
   * href="http://docs.oracle.com/javase/tutorial/java/generics/erasure.html" target="_blank">type erasure</a>.
   * <p/>
   * Examples:
   * 
   * <pre>
   ...
   */
  public @Nonnull
  <T> PropertyTypeRef<T> ofType(@Nonnull TypeRef<T> type) {
