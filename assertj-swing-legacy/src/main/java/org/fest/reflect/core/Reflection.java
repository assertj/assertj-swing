...
public final class Reflection {
  ...
  Type type(@Nonnull String name) {
    return new Type(name);
  }

  /**
   * Starting point of the fluent interface for accessing static inner class via <a
   ...
   */
  public static @Nonnull
  InnerClassName innerClass(@Nonnull String name) {
    return new InnerClassName(name);
  }

  /**
   * Starting point of the fluent interface for accessing fields via <a
   * href="http://docs.oracle.com/javase/tutorial/reflect/index.html" target="_blank">Java Reflection</a>.
   * <p/>
   * Examples:
   * 
   ...
   */
  public static @Nonnull
  FieldName field(@Nonnull String name) {
    return new FieldName(name);
  }

  /**
   * Starting point of the fluent interface for invoking methods via <a
   * href="http://docs.oracle.com/javase/tutorial/reflect/index.html" target="_blank">Java Reflection</a>.
   * <p/>
   * Examples:
   * 
   ...
   */
  public static @Nonnull
  MethodName method(@Nonnull String name) {
    return new MethodName(name);
  }

  /**
   * Starting point of the fluent interface for invoking constructors via <a
   * href="http://docs.oracle.com/javase/tutorial/reflect/index.html" target="_blank">Java Reflection</a>.
   * <p/>
   * Examples:
   * 
  ...
  /**
   * Starting point of the fluent interface for accessing properties via <a
   * href="http://docs.oracle.com/javase/tutorial/javabeans/index.html" target="_blank">Beans Introspection</a>.
   * <p/>
   * Examples:
   * 
   * <pre>
   ...
   */
  public static @Nonnull
  PropertyName property(@Nonnull String name) {
