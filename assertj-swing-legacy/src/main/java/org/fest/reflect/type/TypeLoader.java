 ...
 * {@link org.fest.reflect.core.Reflection#type(String) type}("org.republic.Jedi").{@link Type#load() load}();
 * 
 * // Loads the class 'org.republic.Jedi' as 'org.republic.Person' (Jedi extends Person) Class&lt;Person&gt; jediType =
 * {@link org.fest.reflect.core.Reflection#type(String) type}("org.republic.Jedi").{@link Type#loadAs(Class) loadAs}
 * (Person.class);
 * 
 * // Loads the class 'org.republic.Jedi' using a custom class loader Class&lt;?&gt; jediType =
 * {@link org.fest.reflect.core.Reflection#type(String) type}("org.republic.Jedi").
 * {@link Type#withClassLoader(ClassLoader) withClassLoader}(myClassLoader).
 * {@link org.fest.reflect.type.TypeLoader#load() load}(); </pre>
 * 
 * @author Alex Ruiz
 * @since 1.1
 */
public final class TypeLoader {
   ...
   */
  public @Nonnull
  <T> Class<? extends T> loadAs(@Nonnull Class<T> superType) {
  ...
  private @Nonnull
  Class<?> loadType() throws ClassNotFoundException {
