...
/**
 * Stores the name of the field to access via <a href="http://docs.oracle.com/javase/tutorial/reflect/index.html"
...
public final class FieldName {
   ...
   */
  public @Nonnull
  <T> FieldType<T> ofType(@Nonnull Class<T> type) {
   ...
   * generic types that otherwise would be lost due to <a
   ...
   */
  public @Nonnull
  <T> FieldTypeRef<T> ofType(@Nonnull TypeRef<T> type) {
