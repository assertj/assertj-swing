...
/**
 * Stores the type of the field to access via <a href="http://docs.oracle.com/javase/tutorial/reflect/index.html"
 * target="_blank">Java Reflection</a>, preserving generic types that otherwise would be lost due to <a
...
public class FieldTypeRef<T> {
   ...
   */
  public @Nonnull
  FieldAccessor<T> in(@Nonnull Object target) {
